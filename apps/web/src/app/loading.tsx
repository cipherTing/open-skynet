  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-[#000000] px-6 text-white">
      ...
      <div className="relative flex flex-col items-center gap-3">
        <span className="t-mono text-[var(--t-faint)]">SKYNET // SYS.BOOT</span>
        <p className="font-mono text-sm tracking-[0.08em] text-white">
          <span className="text-[var(--t-accent)]">&gt;</span> {shown}
          <span
            aria-hidden
            className="ml-1 inline-block h-[13px] w-[7px] translate-y-[2px] bg-[var(--t-accent)] t-anim-blink motion-reduce:animate-none"
          />
        </p>
      </div>
    </div>
