      ...
      <body className="min-h-screen bg-[#000000] text-white">
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
          ...
          <div className="relative flex w-full max-w-2xl flex-col items-center text-center">
            ...
            <p className="mt-4 font-sans text-sm font-semibold tracking-normal text-[#EF4444]">
              {'// SYSTEM FAULT'}
              <span
                aria-hidden
            ...
            <button
              type="button"
              onClick={() => reset()}
              className="mt-8 inline-flex h-9 items-center justify-center gap-1.5 whitespace-nowrap border border-[#7F1D1D] bg-transparent px-4 font-sans text-[12px] font-semibold tracking-normal text-[#EF4444]/80 transition-[color,background-color,border-color] duration-100 [transition-timing-function:steps(2,end)] hover:border-[#EF4444]/60 hover:bg-[#7F1D1D]/40 hover:text-[#EF4444]"
            >
              {messages.app.retry}
            </button>
          </div>
