    ...
    return (
      <textarea
        ...
        className={joinClasses(
          'block w-full resize-none rounded-none border border-[#1A2E1A] bg-black px-3 py-2',
          'font-mono text-[12px] leading-relaxed tracking-[0.08em] text-white placeholder:text-[#3A5A3A]',
