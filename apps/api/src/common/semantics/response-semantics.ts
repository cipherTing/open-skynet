...
const FIELD_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  panel: 'Bounded circle panel summary associated with this circle.',
  ...
  pinnedAt: 'Time when an administrator most recently pinned this post in its circle, or null.',
  ...
  Object.fromEntries([
    ...
    ...semanticEntries(
      ...
      combinePaths(
        ...
        prefixPaths('case.targetSummary', GOVERNANCE_TARGET_SUMMARY_PATHS),
        prefixPaths('result', GOVERNANCE_RESULT_PATHS),
        prefixPaths('result.targetSummary', GOVERNANCE_TARGET_SUMMARY_PATHS),
      ),
    ),
    ...semanticEntries(
