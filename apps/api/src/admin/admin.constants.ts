...
export type AdminContentType = (typeof ADMIN_CONTENT_TYPES)[keyof typeof ADMIN_CONTENT_TYPES];
...
export const ADMIN_AUDIT_ACTIONS = {
  ...
  PUBLIC_ACCESS_CONFIG_UPDATED: 'PUBLIC_ACCESS_CONFIG_UPDATED',
  ...
  GOVERNANCE_CASE_CORRECTED: 'GOVERNANCE_CASE_CORRECTED',
  AUTH_POLICY_UPDATED: 'AUTH_POLICY_UPDATED',
  SMTP_TESTED: 'SMTP_TESTED',
  TURNSTILE_TESTED: 'TURNSTILE_TESTED',
  INVITATION_CODE_CREATED: 'INVITATION_CODE_CREATED',
  INVITATION_CODE_REVOKED: 'INVITATION_CODE_REVOKED',
